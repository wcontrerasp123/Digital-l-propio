// ============================================================
// datapath.v
// Camino de datos del multiplicador.
// Conecta: reg_b (multiplexor), contador, comparador, lsr, acc
// ============================================================
module datapath #(
    parameter N         = 16,
    ...
    input  wire             SH,
    input  wire             AD,
    output wire             b_i,   // hacia Control
    output wire             Z,     // hacia Control
    output wire [2*N-1:0]   R      // resultado final
);
